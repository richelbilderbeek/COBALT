static char const rcsid[] = "$Id: cobalt.cpp 470374 2015-06-15 16:40:29Z boratyng $";
...
CMultiAligner::x_SetScoreMatrix(const char *matrix_name)
{
    if (strcmp(matrix_name, "BLOSUM62") == 0)
        ...
        NCBI_THROW(CMultiAlignerException, eInvalidScoreMatrix,
                   "Unsupported score matrix. Valid matrix names: BLOSUM45, BLOSUM62, BLOSUM80, PAM30, PAM70 and PAM250");
}
